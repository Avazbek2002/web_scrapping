...
class Scrapper:
    def __init__(self, URL, list_url):
        ...
        self.website_name = urlparse(URL).netloc.domain.split('.')[0]
        self.log_file = open(f"{self.website_name}Logs.txt", "w")
        self.csv_file = self.create_csv_file(f"{self.website_name}_scrap.txt", "w")
    ...
    def driver_config(self):
        ...
        self.options.add_argument(self.chrome_profile)
